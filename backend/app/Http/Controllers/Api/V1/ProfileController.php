...
class ProfileController extends Controller
{
    ...
    {
        $request->validate([
            'avatar' => 'required|image|mimes:jpeg,png,jpg,gif,webp|max:10240', // Max 10MB
        ]);
    ...
    #[OA\Post(path: "/api/v1/auth/profile/cover", summary: "Mettre à jour la photo de couverture", tags: ["Profil"])]
    #[OA\Response(response: "200", description: "Couverture mise à jour")]
    public function updateCover(Request $request)
    {
        $request->validate([
            'cover' => 'required|image|mimes:jpeg,png,jpg,gif,webp|max:10240',
        ]);
